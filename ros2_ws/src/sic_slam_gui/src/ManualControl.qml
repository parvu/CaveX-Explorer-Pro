...
Rectangle {
  id: panel
  width: ManualControl.mode === "depth" ? 100 : 150
  height: ManualControl.mode === "depth" ? 96 : 96
  color: "#66000000"
  radius: 6
  ...
  // D-pad: left/fwd/right/rev around a center stop.
  Grid {
    visible: ManualControl.mode !== "depth"
    anchors.centerIn: parent
    columns: 3
    rows: 3
    spacing: 2
